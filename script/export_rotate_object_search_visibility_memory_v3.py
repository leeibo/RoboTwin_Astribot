...
TASK_TYPE_NAME = "object_search_visibility_memory_v3"
DEFAULT_OUTPUT_DIR_NAME = "vlm_object_search_visibility_memory_v3"
...
def _episode_samples_payload(
    ...
    return {
        ...
        "action_count": int(len(stage3_samples)),
        "samples": samples,
    }
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Export rotate object-search visibility-memory v3 samples. "
            "v3 keeps v2 search/direct samples and expands stage3 action chunks with shifted chunk offsets."
        )
    )
