...
| 模型 | Step | 启动命令 |
|---|---:|---|
| `fast_subtask_action_12_ws` | 200,000 | `bash ./eval_seed_whitelist_randomized.sh fast_subtask_action_12_ws` |
| `gr00t_subtask_action_12_ws` | 150,000 | `bash ./eval_seed_whitelist_randomized.sh gr00t_subtask_action_12_ws` |
| `gr00tdual_subtask_action_12_wos` | 110,000 | `bash ./eval_seed_whitelist_randomized.sh gr00tdual_subtask_action_12_wos` |
| `gr00tdual_subtask_action_12_ws` | 110,000 | `bash ./eval_seed_whitelist_randomized.sh gr00tdual_subtask_action_12_ws` |
...
| `oft_no_no_0_wos` | 100,000 | `bash ./eval_seed_whitelist_randomized.sh oft_no_no_0_wos` |
...
| `oft_subtask_motion_6_ws` | 55,000 | `bash ./eval_seed_whitelist_randomized.sh oft_subtask_motion_6_ws` |
| `oft_subtask_subtask_12_ws` | 60,000 | `bash ./eval_seed_whitelist_randomized.sh oft_subtask_subtask_12_ws` |
| `oft_subtask_subtask_6_ws` | 55,000 | `bash ./eval_seed_whitelist_randomized.sh oft_subtask_subtask_6_ws` |
| `planner_oft` | Action 100,000 / Planner 100,000 | `bash ./eval_seed_whitelist_randomized.sh planner_oft` |
