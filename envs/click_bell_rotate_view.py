...
class _click_bell(Base_Task):
    ...
    def play_once(self):
        ...
        # You must use the same pre_grasp_dis and grasp_dis values as in the _click_bell task
...
class click_bell_rotate_view(_click_bell):
