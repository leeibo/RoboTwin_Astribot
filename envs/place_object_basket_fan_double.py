...
class place_object_basket_fan_double(Base_Task):
    ...
    def play_once(self):
        ...
        maybe_reset_head_for_subtask(self, 1, prev_subtask_idx=prev_subtask_idx)
        object_key = search_focus(self, 1)
        ...
        if self.plan_success:
            maybe_reset_head_for_subtask(self, 2, prev_subtask_idx=prev_subtask_idx)
            self._prepare_basket_rotate_search()
            basket_key = search_focus(self, 2)
