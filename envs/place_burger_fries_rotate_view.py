...
class place_burger_fries_rotate_view(place_burger_fries):
            ...
            subtask_defs=[
                {
                    ...
                    "done_when": "hamburger_grasped",
                    "next_subtask_id": 2,
                },
                {
                    "id": 2,
                    "name": "place_hamburger_on_tray",
                    "instruction_idx": 2,
                    ...
                    "allow_stage2_from_memory": True,
                    "done_when": "hamburger_on_tray",
                    "next_subtask_id": 3,
                },
                {
                    "id": 3,
                    "name": "pick_frenchfries",
                    "instruction_idx": 3,
                    ...
                    "allow_stage2_from_memory": True,
                    "done_when": "frenchfries_grasped",
                    "next_subtask_id": 4,
                },
                {
                    "id": 4,
                    "name": "place_frenchfries_on_tray",
                    "instruction_idx": 4,
                    "search_target_keys": ["B"],
    ...
    def play_once(self):
        hamburg_key = self.search_and_focus_rotate_subtask(
            1,
            scan_r=0.62,
            scan_z=0.88 + self.table_z_bias,
            joint_name_prefer="astribot_torso_joint_2",
        ...
        self.enter_rotate_action_stage(1, focus_object_key=(hamburg_key or "A"))
        ...
        tray_key = self.search_and_focus_rotate_subtask(
            2,
            scan_r=0.62,
            scan_z=0.88 + self.table_z_bias,
            joint_name_prefer="astribot_torso_joint_2",
        )
        self.enter_rotate_action_stage(2, focus_object_key=(tray_key or "B"))
        self.move(
            self.place_actor(
                self.hamburg,
        ...
        fries_key = self.search_and_focus_rotate_subtask(
            3,
            scan_r=0.62,
            scan_z=0.88 + self.table_z_bias,
            joint_name_prefer="astribot_torso_joint_2",
        )
        self.enter_rotate_action_stage(3, focus_object_key=(fries_key or "C"))
        ...
        self.enter_rotate_action_stage(4, focus_object_key=(tray_key or "B"))
        self.move(
            self.place_actor(
                self.frenchfries,
