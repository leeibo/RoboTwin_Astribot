...
class _blocks_ranking_rgb(Base_Task):
...
class blocks_ranking_rgb_rotate_view(_blocks_ranking_rgb):
    ...
    def play_once(self):
        ...
        self.move(self.grasp_actor(self.block2, arm_tag=arm_tag2, pre_grasp_dis=0.09, grasp_dis=0.01))
        ...
        self.move(self.grasp_actor(self.block3, arm_tag=arm_tag3, pre_grasp_dis=0.09, grasp_dis=0.01))
