...
class pick_diverse_bottles_rotate_view(pick_diverse_bottles):
    ...
    def load_actors(self):
        ...
        self.bottle1_id = int(np.random.choice(self.id_list))
        self.bottle2_id = int(np.random.choice(self.id_list))
        ...
        while True:
            ...
            if np.linalg.norm(bottle2_pose.p[:2] - self.bottle1.get_pose().p[:2]) < 0.15:
                continue
            break
